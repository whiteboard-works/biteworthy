...
> BiteWorthy is live in Durango.
>
> A free dietary filter for restaurant menus — built solo, on cheap independent infrastructure (Hetzner CPX21, Neon, Cloudflare R2, Vercel for the web — total ~$9/mo all-in), open-sourced.
>
